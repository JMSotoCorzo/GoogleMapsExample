...
public class MapsActivity extends FragmentActivity implements LocationListener, AsyncSearchResponse, AsyncTraceResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                destination = new LatLng(resultPlaces.get(i).getLatitude(),resultPlaces.get(i).getLongitude());

                String url = getMapsApiDirectionsUrl(destination);
    ...
    public void traceFinish(PolylineOptions route){
        ...
        originMark.position(new LatLng(currentLatitude, currentLongitude));
        originMark.title("Your position");
        googleMap.addMarker(originMark);

        MarkerOptions destinationMark = new MarkerOptions();
        destinationMark.position(destination);
        destinationMark.title("Your destiny");
        googleMap.addMarker(destinationMark);

        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(destination) // Center Set
                .zoom(11.0f)                // Zoom
    ...
    private String getMapsApiDirectionsUrl(LatLng destiny) {
        ...
        String destination = "destination=" + destiny.latitude + "," + destiny.longitude;
